...
<div class="cap-default-index">
    ...
    <div class="jumbotron">
        ...
        <p><?= Html::a(Yii::t('app','Get start to create an account'),'account/create',["class"=>"btn btn-lg btn-success"])?></p>
    </div>
    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p><?= Html::a(Yii::t('app','Go to Account'),'account',["class"=>"btn btn-primary"])?></p>
            </div>
            <div class="col-lg-4">
                <h2>Transaction</h2>
                ...
                <p><?= Html::a(Yii::t('app','Go to Transaction'),'transaction',["class"=>"btn btn-primary"])?></p>
            </div>
            <div class="col-lg-4">
                <h2>Journal</h2>
                ...
                <p><?= Html::a(Yii::t('app','Go to Journal'),'journal',["class"=>"btn btn-primary"])?></p>
            </div>
        </div>
